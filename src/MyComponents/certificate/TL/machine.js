...
// import { a } from "../../assets/xlr8-mentee"
// import { aerial_ment } from "../../../assets/aerialment"
import { machine_ment } from "../../../assets/machinement";
...
export default function Machine() {
  ...
  const downloadfile = async () => {
    ...
    const link = `${window.location.href}certificates/Certificates_MachineTraining/${key}.png`;
    await saveAs(link, "machine_certificate.png");
    // if (ismentee) {
    //   var mentee = document.getElementById("mentee").value;
    //   key = mentee.replace(/\s+/g, "%20");
