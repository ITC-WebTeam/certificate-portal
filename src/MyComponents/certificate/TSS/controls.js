...
import { control_ment } from "../../../assets/controlsment"
...
export default function Controls() {
  ...
  const downloadfile = async () => {
    ...
    const link = `${window.location.href}certificates/Controls/${key}.png`;
    await saveAs(link, "controls.png");
    // if (ismentee) {
    //   var mentee = document.getElementById("mentee").value;
    //   key = mentee.replace(/\s+/g, "%20");
