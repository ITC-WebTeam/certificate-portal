...
import { con_101 } from "../../../assets/con101ment";

export default function Con101() {
  var type;
  ...
  const downloadfile = async () => {
    ...
    const link = `${window.location.href}certificates/Con-101/${key}.png`;
    await saveAs(link, "con101.png");
    // if (ismentee) {
    //   var mentee = document.getElementById("mentee").value;
    //   key = mentee.replace(/\s+/g, "%20");
