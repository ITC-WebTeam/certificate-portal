...
import { finance_ment } from "../../../assets/financement";
...
export default function Finance() {
  ...
  const downloadfile = async () => {
    ...
    const link = `${window.location.href}certificates/Finance/${key}.png`;
    await saveAs(link, "financial_market.png");
    // if (ismentee) {
    //   var mentee = document.getElementById("mentee").value;
    //   key = mentee.replace(/\s+/g, "%20");
