...
import { manage_ment } from "../../../assets/management";
...
export default function Manage() {
  ...
  const downloadfile = async () => {
    ...
    const link = `${window.location.href}certificates/Management-bootcamp/${key}.png`;
    await saveAs(link, "management-bootcamp.png");
    // if (ismentee) {
    //   var mentee = document.getElementById("mentee").value;
    //   key = mentee.replace(/\s+/g, "%20");
